...
${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob10_MilesPerGallon.o: Gaddis_8thEd_Chap2_Prob10_MilesPerGallon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob10_MilesPerGallon.o Gaddis_8thEd_Chap2_Prob10_MilesPerGallon.cpp

${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob13_CircuitBoardPrice.o: Gaddis_8thEd_Chap2_Prob13_CircuitBoardPrice.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob13_CircuitBoardPrice.o Gaddis_8thEd_Chap2_Prob13_CircuitBoardPrice.cpp

${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob14_PersonalInfo.o: Gaddis_8thEd_Chap2_Prob14_PersonalInfo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob14_PersonalInfo.o Gaddis_8thEd_Chap2_Prob14_PersonalInfo.cpp

${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob1_SumOf2Numbers.o: Gaddis_8thEd_Chap2_Prob1_SumOf2Numbers.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob1_SumOf2Numbers.o Gaddis_8thEd_Chap2_Prob1_SumOf2Numbers.cpp

${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob3_SalesTax.o: Gaddis_8thEd_Chap2_Prob3_SalesTax.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob3_SalesTax.o Gaddis_8thEd_Chap2_Prob3_SalesTax.cpp

${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob4_RestaurantBill.o: Gaddis_8thEd_Chap2_Prob4_RestaurantBill.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob4_RestaurantBill.o Gaddis_8thEd_Chap2_Prob4_RestaurantBill.cpp

${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob6_AnnualPay.o: Gaddis_8thEd_Chap2_Prob6_AnnualPay.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob6_AnnualPay.o Gaddis_8thEd_Chap2_Prob6_AnnualPay.cpp

${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob8_TotalPurchase.o: Gaddis_8thEd_Chap2_Prob8_TotalPurchase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gaddis_8thEd_Chap2_Prob8_TotalPurchase.o Gaddis_8thEd_Chap2_Prob8_TotalPurchase.cpp
