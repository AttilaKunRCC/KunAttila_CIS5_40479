/* 
  File:   Gaddis_8thEd_Chapter5_Prob20_RandomNumberGuessCount.cpp
  Author: Attila Kun
 ...
 * - the program should use a loop that repeats until the user correctly guesses the random number, and display the number of guesses before succeding 
 */
